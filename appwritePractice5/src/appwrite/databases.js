...
collections.forEach((col) =>{
    db[col.name] ={
        ...
        create: (payload, permissions, id=ID.unique())=> databases.createDocument(col.dbId, col.id, id, payload, permissions),
        update: (payload, id, permissions) => databases.updateDocument(col.dbId, col.id, id, payload, permissions),
